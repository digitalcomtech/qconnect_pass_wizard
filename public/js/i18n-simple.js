...
const translations = {
  en: {
    "app.title": "PASS Provisioning Console",
    "app.language": "Language",
    "installation.title": "Office provisioning for Pegasus",
    "installation.clientSelection": "Find installation",
    "installation.enterClientName": "Client name, VIN, or installation ID",
    "installation.vinSelection": "Select VIN",
    ...
    "buttons.back": "Back",
    "buttons.startInstallation": "Provision in Pegasus",
  ...
  es: {
    "app.title": "Consola de aprovisionamiento PASS",
    "app.language": "Idioma",
    "installation.title": "Aprovisionamiento en oficina (Pegasus)",
    "installation.clientSelection": "Buscar instalación",
    "installation.enterClientName": "Cliente, VIN o ID de instalación",
    "installation.vinSelection": "Seleccionar VIN",
    "installation.chooseVin": "Elegir VIN objetivo",
    "installation.deviceSetup": "Dispositivos y SIM",
    "installation.enterImeiSim": "Dispositivos, SIM y aprovisionar",
    ...
    "buttons.back": "Atrás",
    "buttons.startInstallation": "Aprovisionar en Pegasus",
